...
export_dir = '/ssynthesia/ghostcity/git/codename-cyborg/02401.00009_data-generation-test-set/generated-mifs/'
try:
    os.mkdir(export_dir)
...
amplitude_range = range(51,61)  # --- mT, excluding 61
...
for amp in amplitude_range:
    for freq in frequency_range:
        ...
        # Padding the frequency with zero
        if len(freq) == 1:
            freq = '0' + freq
