...
mif_dir="/ssynthesia/ghostcity/git/codename-cyborg/02312.00001_data-generation/generated-mifs"

# The directory where the output ODT files will be exported to
out_dir="/ssynthesia/ghostcity/git/codename-cyborg/02312.00002_simulation-run/odt-archives"
