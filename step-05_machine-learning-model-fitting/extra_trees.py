...
dumper_test_error = '/ssynthesia/ghostcity/git/codename-cyborg/02401.00013_coding-for-actual-modeling/results/data-raw-et.csv'
...
def run_modeling(train=None, test=None, feature_filter=None, csv_path='', trimming=None, comment=''):
    ...
    print()
    print('='*25)
    print('ACTUAL DATA MODELING: EXTRA TREES')
...
base = '/ssynthesia/ghostcity/git/codename-cyborg/02401.00013_coding-for-actual-modeling/results/et-no-trim-'
...
# The base output CSV directory path
base = '/ssynthesia/ghostcity/git/codename-cyborg/02401.00013_coding-for-actual-modeling/results/et-trim-149-'
